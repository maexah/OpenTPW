...
Fifty-seven of the hundred and fifteen unit tests read real game files and skip when no installation is found - so a green run on a machine that has never had the game means 58 ran and 57 did not. Set `OPENTPW_GAME_PATH` to run all of them.

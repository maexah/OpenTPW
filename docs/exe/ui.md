...
| `0x005e41c0` | `IslandLobby_OnKey` | Opens the menu on Escape | Ghidra |
...
Go Online is a dead end — it only closes. Escape over a modal window (message box, options) does nothing here — **unproven**.

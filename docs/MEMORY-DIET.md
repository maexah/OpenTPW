...
| `codebase-review-and-plan.md` | 10 KB | Keep the phase list (A, B, E, F unbuilt) in `docs/STATUS.md`. The artifact links go there too. | Done 2026-09-24, to the queue instead of STATUS: its open work is `QUEUE.md` Q70-Q75, its artifacts and decisions are in `docs/history/README.md`, its data path in `CLAUDE.local.md`. |

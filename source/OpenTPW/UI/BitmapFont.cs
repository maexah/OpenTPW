...
/// the last for most glyphs and the first for the rest. The blitter (0x006b15f0) moves what is
/// underneath towards the text's colour by the coverage over fifteen.
/// </para>
/// </summary>

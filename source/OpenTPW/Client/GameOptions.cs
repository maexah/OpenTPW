...
internal sealed class GameOptions
{
	...
	/// <summary>
	/// +0x39: whether a quick right click puts away whatever is in the hand - see <c>Level.QuickRightClick</c> - and whether
	/// a right click on the view leaves first person (<c>ParkViewfinder.RightClicked</c>).
	/// </summary>

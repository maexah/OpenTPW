...
/// group volumes that the advisor lowers while he talks and the options screen sets.
/// <see cref="Audio.Duck"/> and <see cref="Audio.SetBusVolume"/> are the same idea, so a voice has to
/// say which group it is in before either can reach it.
///
